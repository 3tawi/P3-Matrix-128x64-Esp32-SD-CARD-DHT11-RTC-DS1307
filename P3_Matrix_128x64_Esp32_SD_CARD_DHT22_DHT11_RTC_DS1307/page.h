...
function GetArduinodata() {
  ...
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
            ...
            spee2     = this.responseXML.getElementsByTagName('analog')[8].childNodes[0].nodeValue;
            spee3     = this.responseXML.getElementsByTagName('analog')[9].childNodes[0].nodeValue;
            spee4     = this.responseXML.getElementsByTagName('analog')[10].childNodes[0].nodeValue;
    }
    ...
    document.getElementById("Sped4").innerHTML = spee4 + "s";
        ...
        <table>
         <form action="/" method="POST">
            <td style="width:22">
                ...
                <input type="number" name="Pattern" min="1" max="26" value="13" class="button-blue" style="width:30%" id="Modepat">
...
<tr>
    <table>
        ...
        <input style="width:58%" type="range" name="Speed2" min="0" max="20" value="12" class="slider" id="mySpeed2">
        <button class="button-blue" onclick="myFunctionS2()" style="width:20%"><b><span>Hue</span></b></button>
        <b class="button-blue" style="width:14%"><span id="Sped2"></span></b>
            <script>
...
<tr>
    <table>
        ...
        <input style="width:58%" type="range" name="Speed3" min="0" max="19" value="0" class="slider" id="mySpeed3">
        <button class="button-blue" onclick="myFunctionS3()" style="width:20%"><b><span>Color</span></b></button>
        <b class="button-blue" style="width:14%"><span id="Sped3"></span></b>
            <script>
...
<tr>
    <table>
        ...
        <input style="width:58%" type="range" name="Speed4" min="2" max="240" value="10" class="slider" id="mySpeed4">
        <button class="button-blue" onclick="myFunctionS4()" style="width:20%"><b><span>Timer</span></b></button>
        <b class="button-blue" style="width:14%"><span id="Sped4"></span></b>
            <script>
