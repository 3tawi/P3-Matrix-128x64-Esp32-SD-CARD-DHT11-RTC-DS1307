...
CRGBPalette16 MesgPalette;
  ...
  void setupMesgPalette(int Coun) {
   if( Coun == 0) MesgPalette =  LavaColors_p;
   if( Coun == 1) MesgPalette =  OceanColors_p;
   if( Coun == 2) MesgPalette =  CloudColors_p;
   if( Coun == 3) MesgPalette =  HeatColors_p ;
   if( Coun == 4) MesgPalette =  PartyColors_p;
   if( Coun == 5) MesgPalette =  ForestColors_p;
   if( Coun == 6) MesgPalette =  RainbowColors_p;
   if( Coun == 7) MesgPalette =  RainbowStripeColors_p;
   if( Coun == 8) MesgPalette  = CRGBPalette16(CRGB::Red, CRGB::Red, CRGB::Green, CRGB::Green);
   if( Coun == 9) MesgPalette  = CRGBPalette16(CRGB::Red, CRGB::Orange, CRGB::Red, CRGB::Black);
   if( Coun == 10) MesgPalette = CRGBPalette16(CRGB::DeepPink, CRGB::Blue, CRGB::Violet, CRGB::White);
   if( Coun == 11) MesgPalette = CRGBPalette16(CRGB::Red, CRGB::GreenYellow, CRGB::Gold, CRGB::White);
   if( Coun == 12) MesgPalette = CRGBPalette16(CRGB::Orange, CRGB::DeepPink, CRGB::Aqua, CRGB::White);
   if( Coun == 13) MesgPalette = CRGBPalette16(CRGB::Red, CRGB::Purple, CRGB::Navy, CRGB::GreenYellow);
   if( Coun == 14) MesgPalette = CRGBPalette16(CRGB::Aqua, CRGB::Purple, CRGB::DeepPink, CRGB::Red);
   if( Coun == 15) MesgPalette = CRGBPalette16(CRGB::Red, CRGB::DeepPink, CRGB::Gold, CRGB::White);
   if( Coun == 16) MesgPalette = CRGBPalette16(CRGB::Violet, CRGB::Yellow, CRGB::Gold, CRGB::White);
   if( Coun == 17) MesgPalette = CRGBPalette16(CRGB::DeepPink, CRGB::Red, CRGB::Purple, CRGB::White);
   if( Coun == 18) MesgPalette = CRGBPalette16(CRGB::Red, CRGB::Orange, CRGB::Gold, CRGB::DarkOrange);
   if( Coun == 19) MesgPalette = CRGBPalette16(CRGB::Red,  CRGB::Crimson,  CRGB::Orange,  CRGB::DarkOrange, CRGB::Yellow, CRGB::Gold, CRGB::Green,  CRGB::GreenYellow,
  ...
  void drawRGBPixel(int16_t x, int16_t y, int16_t color) {
  ...
  void drawRGBBitmap(int16_t x, int16_t y, const uint16_t bitmap[], int16_t w, int16_t h) {
    for (int16_t j = 0; j < h; j++, y++) {
      for (int16_t i = 0; i < w; i++){
        int16_t color = pgm_read_word(&bitmap[j * w + i]);
  ...
  void drawLine(int x0, int y0, int x1, int y1, int16_t color)
  {
...
void fillCircle(int16_t x0, int16_t y0, int16_t r, int16_t color) {
  drawFastVLine(x0, y0 - r, 2 * r + 1, color);
  fillCircleHelper(x0, y0, r, 3, 0, color);
}

void fillCircleHelper(int16_t x0, int16_t y0, int16_t r, uint8_t corners, int16_t delta, int16_t color) {
...
{
  uint32_t ioffset = noise_scale_x * (x - MATRIX_WIDTH);
  uint32_t joffset = noise_scale_y * (y - MATRIX_HEIGHT);
  byte data = inoise16(noise_x + ioffset, noise_y + joffset, noise_z) >> 8;
  uint8_t olddata = noise;
  uint8_t newdata = scale8(olddata, noisesmoothing) + scale8(data, 256 - noisesmoothing);
  noise = newdata;
  CRGB pixel = ColorFromPalette(MesgPalette, (1 + noise) * 5, 255, LINEARBLEND);
  matrix.drawPixel(x, y, matrix.Color888(pixel.r, pixel.g, pixel.b, true));
}
